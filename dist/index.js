 ...
 * @param num
 */
var zhNum = ['零', '一', '二', '三', '四', '五', '六', '七', '八', '九', '十'];
export function numToZh(num) {
    ...
    if (10 < Number(num) && Number(num) < 20) {
        var tenDigitsArr = String(num).split('');
        rel = '十' + zhNum[Number(tenDigitsArr[1])];
        return rel;
    }
    if (Number(num) < 100) {
        var moreTenArr = String(num).split('');
        if (moreTenArr[1] === '0') {
    ...
    if (Number(num) >= 100 && Number(num) < 1000) {
        var threeDigitsArr = String(num).split('');
    ...
    if (Number(num) >= 1000 && Number(num) < 10000) {
        var fourDigitsArr = String(num).split('');
        var THOUSAND = zhNum[Number(fourDigitsArr[0])] + '千';
        // eg: 1000
    ...
    if (Number(num) >= 10000 && Number(num) < 100000) {
        var fivesDigitsArr = String(num).split('');
        var TEN_THOUSAND = zhNum[Number(fivesDigitsArr[0])] + '万';
        // eg: 10000
        if (fivesDigitsArr[1] === '0' &&
            fivesDigitsArr[2] === '0' &&
            fivesDigitsArr[3] === '0' &&
            fivesDigitsArr[4] === '0') {
